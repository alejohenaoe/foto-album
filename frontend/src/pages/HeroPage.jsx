...
export default function HeroPage() {
    ...
    return (
        <div id='ingreso_galeria' className="h-[calc(100vh-4rem)] flex flex-col items-center justify-center text-white">
            ...
            <div className="text-center mb-8 md:mb-16 max-w-3xl px-4">
                <p className="text-4xl md:text-6xl lg:text-7xl font-light leading-tight mb-4 font-serif">
                    Doy vida a tu historia
                </p>
                <p className="text-2xl md:text-4xl lg:text-6xl font-light">
